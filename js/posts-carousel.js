...
document.addEventListener("DOMContentLoaded", function() {
    const carouselElement = document.getElementById("mzaCarousel");
    if (carouselElement) {
        try {
            const mza = new MzaCarousel(carouselElement, {
                transitionMs: 900
            });
            console.log("MzaCarousel initialized successfully");
        } catch (error) {
            console.error("Error initializing MzaCarousel:", error);
        }
    } else {
        console.warn("MzaCarousel element not found");
    }
});
...
function initCarousel() {
    ...
    if (carouselElement && !carouselElement.dataset.initialized) {
        try {
            ...
            console.log("MzaCarousel initialized successfully (delayed)");
        } catch (error) {
            console.error("Error initializing MzaCarousel:", error);
        }
    }
